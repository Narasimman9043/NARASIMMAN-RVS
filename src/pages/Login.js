...
import { Eye, EyeOff, Mail, Lock, User, Heart, Loader } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {isLogin 
                ...
                : 'Start tracking your mood and mental wellness'
              }
            </p>
          </div>
          ...
          <button
            ...
            className="w-full mb-6 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center space-x-3"
          >
            {isGoogleLoading ? (
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Your mental health matters. Track, understand, and improve your wellbeing.
          </p>
        </div>
      </div>
    </div>
